...
design choice and is outside the scope of this algorithm description as the actual strategy depends on the application.
 For instance for a video conferencing application it can be better to avoid discarding media frames even though they are late,
